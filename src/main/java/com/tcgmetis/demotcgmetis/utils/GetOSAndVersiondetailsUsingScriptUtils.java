...
public class GetOSAndVersiondetailsUsingScriptUtils {
	
	public String getOSAndVersionDetail(String hostip,String script) {
        ...
        try {
            ...
            session = jsch.getSession("anup", hostip, 22);
            ...
            channelExec.setCommand(script); //sh myscript.sh 
