...
import static com.tcgmetis.demotcgmetis.utils.Constants.INDEX;
...
public class ProfileService {
	...
	public String createProfileDocument(ProfileDocument document) throws Exception {
        ...
        IndexRequest indexRequest = new IndexRequest(INDEX).id(document.getId()).source(convertProfileDocumentToMap(document), XContentType.JSON);
